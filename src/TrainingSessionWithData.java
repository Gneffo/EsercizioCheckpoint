...
public class TrainingSessionWithData {
    ...
    public TrainingSessionWithData(List<TrainingSessionData> trainingSessionData, int idTrainingSession, Date startTime, Date endTime, Session sessionType, String userUsername) {
        this.trainingSessionData = trainingSessionData;
        this.idTrainingSession = idTrainingSession;
        this.startTime = startTime;
        this.endTime = endTime;
